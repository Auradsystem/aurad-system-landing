...
const scenarios: Scenario[] = [
  {
    ...
    description:
      "Vous avez un projet avec des lots techniques (sécurité, incendie, contrôle d'accès, caméras thermiques, GTC). Vous n'avez pas l'expertise interne pour cadrer les besoins, choisir les entreprises, piloter le chantier.",
    steps: [
      {
        title: "Audit de besoins",
        desc: "Contraintes réglementaires, calendrier, budget, identification des opérations éligibles aux CEE.",
        iconName: "ClipboardList",
      },
      {
        title: "Rédaction de CCTP",
        desc: "Cahiers des charges pour chaque lot. Les entreprises savent ce qu'on attend d'elles.",
        iconName: "FileText",
      },
      {
        title: "Analyse des offres",
        desc: "Comparaison sur la technique, le planning, la conformité. Pas seulement le prix.",
        iconName: "BarChart2",
      },
      {
        title: "Pilotage chantier",
        desc: "Coordination des entreprises, vérification de conformité, interfaces entre lots.",
        iconName: "HardHat",
      },
      {
        title: "Réception",
    ...
    result:
      "Vous évitez 15-25% de surcoûts en moyenne et gagnez 2-6 semaines sur le planning.",
  ...
  },
  {
    ...
    description:
      "L'analyse du DCE, la rédaction du mémoire technique et le chiffrage vous prennent 8-15 heures. Vous ne savez pas si votre offre sera compétitive.",
    steps: [
      {
        title: "Analyse du DCE",
        desc: "Points ambigus, risques, opportunités de différenciation.",
        iconName: "Search",
      },
      {
        title: "Stratégie de réponse",
        desc: "Positionnement prix, différenciation technique, planning.",
        iconName: "Crosshair",
      },
      {
        title: "Mémoire technique",
        desc: "Structuré pour valoriser vos compétences. Plus de copier-coller.",
        iconName: "PenTool",
      },
      {
        title: "Optimisation chiffrage",
        desc: "Cohérence technique/prix. Éviter les marchés à perte.",
        iconName: "TrendingUp",
      },
    ],
    kpiValue: "+20%",
    ...
    result:
      "+10-20% de taux de transformation sur vos réponses. Vous traitez les AO stratégiques sans y passer 3 jours.",
  ...
  },
  {
    ...
    description:
      "Vous pilotez un projet de construction ou rénovation. La coordination générale, c'est votre métier. Les lots techniques (sécurité incendie, caméras thermiques, GTC, contrôle d'accès), pas forcément. Je travaille avec un réseau de partenaires architectes pour couvrir l'ensemble de vos besoins.",
    steps: [
      {
        title: "CCTP techniques",
        desc: "Rédaction des cahiers des charges lots spéciaux (sécurité, incendie, caméras thermiques, GTC, CFO/CFA).",
        iconName: "FileJson",
      },
      {
        title: "Analyse des offres",
        desc: "Comparaison des offres des entreprises spécialisées.",
        iconName: "Users",
      },
      {
        title: "Coordination chantier",
        desc: "Pilotage lots techniques, interfaces électricité / GTC / sécurité.",
        iconName: "Activity",
      },
      {
        title: "Réceptions techniques",
        desc: "Validation des installations et des DOE. Projet complet.",
        iconName: "Award",
      },
    ],
    kpiValue: "100%",
    ...
    result:
      "Vous gardez la relation client et livrez un projet complet, sans sous-traiter à un bureau d'études généraliste.",
          ...
          {scenarios.map((s) => (
            <button
              ...
              onClick={() => {
                setActiveId(s.id);
                pushEvent({
                  event: "scenario_select",
                  scenario_name: s.id as "amo" | "ao" | "moe",
                });
              }}
            ...
            >
              ...
              <div>
                <div
                  className={`text-sm font-bold ${activeId === s.id ? "text-white" : "text-gray-300"}`}
                >
                  {s.tabTitle}
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="bg-slate-900/50 rounded-2xl p-6 md:p-8 border border-white/5">
                  <h4 className="text-xs font-bold text-aurad-500 uppercase tracking-widest mb-8">
                    Processus
                  </h4>
              ...
              <div className="lg:w-72 xl:w-80 shrink-0 flex flex-col gap-5">
                ...
                <div className="rounded-2xl bg-gradient-to-br from-aurad-900/30 to-slate-900 border border-aurad-500/15 p-6">
                  <div className="text-xs font-bold text-aurad-500 uppercase tracking-widest mb-4">
                    Résultat
                  </div>
                  <div className="text-5xl font-bold text-aurad-400 mb-2">
                    {active.kpiValue}
                  </div>
